          ...
          <div class="p-8 lg:p-12 flex flex-col justify-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-auto">
              <div class="flex items-center border border-border-light dark:border-border-dark rounded-lg overflow-hidden w-full sm:w-32 bg-surface-light dark:bg-surface-dark">
                <button class="px-3 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 transition w-full h-full flex items-center justify-center"><span class="material-icons-outlined text-sm">remove</span></button>
                <input class="w-full text-center border-none focus:ring-0 bg-transparent text-gray-900 dark:text-white font-medium p-0" readonly type="text" value="1" />
                <button class="px-3 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 transition w-full h-full flex items-center justify-center"><span class="material-icons-outlined text-sm">add</span></button>
              </div>
              <button class="flex-1 bg-primary hover:bg-indigo-700 text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center text-lg uppercase tracking-wider">
